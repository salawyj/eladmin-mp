...
CREATE TABLE `app_user` (
                            ...
                            `invitation_code` varchar(180) DEFAULT NULL COMMENT '邀请码',
                            PRIMARY KEY (`user_id`) USING BTREE,
                            UNIQUE KEY `uniq_email` (`email`) USING BTREE,
                            UNIQUE KEY `uniq_username` (`username`) USING BTREE,
                            KEY `idx_enabled` (`enabled`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='app用户';

BEGIN;
INSERT INTO `app_user` (`user_id`, `username`, `nick_name`, `gender`, `phone`, `email`, `avatar_name`, `avatar_path`, `password`,  `enabled`, `create_by`, `update_by`, `pwd_reset_time`, `create_time`, `update_time`)
VALUES (1, 'app-user-test', '手机端测试用户', '男', '18888888888', '201507802@qq.com', 'avatar-20250114101539224.png', '/Users/jie/Documents/work/me/admin/eladmin-mp/eladmin/~/avatar/avatar-20250114101539224.png', '$2a$10$Egp1/gvFlt7zhlXVfEFw4OfWQCGPw0ClmMcc6FjTnvXNRVf9zdMRa', b'1', b'1', NULL, '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2020-09-05 10:43:31');
COMMIT;
...
CREATE TABLE `app_role` (
                            ...
                            KEY `idx_level` (`level`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='app角色表';

-- ----------------------------
-- Records of app_role
-- ----------------------------
BEGIN;
INSERT INTO `app_role` (`role_id`, `name`, `level`, `description`, `data_scope`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (2, '普通用户', 2, '-', '本级', NULL, 'admin', '2018-11-23 13:09:06', '2020-09-05 10:45:12');
COMMIT;
...
CREATE TABLE `app_amount` (
                              ...
                              `invite_num` bigint(20) NOT NULL COMMENT '邀请数量',
                              `create_by` varchar(255) DEFAULT NULL COMMENT '创建者',
                              `update_by` varchar(255) DEFAULT NULL COMMENT '更新者',
                              `create_time` datetime DEFAULT NULL COMMENT '创建日期',
                              `update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `app_amount` (`amount_id`, `app_user_id`, `recharge_total`,  `gift_total`,  `recharge_balance`,  `gift_balance`, `unit_`, `invite_num`, `create_by`, `update_by`,`create_time`, `update_time`) VALUES (2, 2, 2.50, 2.00,2.50,0.50,'元',  0,NULL, 'admin', '2018-11-23 13:09:06', '2020-09-05 10:45:12');
...
CREATE TABLE `app_invite_code` (
                                   `code` VARCHAR(10) PRIMARY KEY COMMENT '邀请码',
