...
public class AppInviteRecordServiceImpl extends ServiceImpl<AppInviteRecordMapper, AppInviteRecord> implements AppInviteRecordService {
    ...
    public void update(AppInviteRecord resources) {
        AppInviteRecord appInviteRecord = getById(resources.getFreeMarker template error (DEBUG mode; use RETHROW in production!):
The following has evaluated to null or missing:
==> pkCapitalColName  [in template "admin/ServiceImpl.ftl" at line 76, column 66]
...
FTL stack trace ("~" means nesting-related):
	- Failed at: ${pkCapitalColName}  [in template "admin/ServiceImpl.ftl" at line 76, column 64]
----
